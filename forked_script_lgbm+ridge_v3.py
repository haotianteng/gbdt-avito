...
print("\nData Load Stage")
training = pd.read_csv('/home/heavens/cqt-avito/data/train.csv', index_col = "item_id", parse_dates = ["activation_date"])
traindex = training.index
testing = pd.read_csv('/home/heavens/cqt-avito/data/test.csv', index_col = "item_id", parse_dates = ["activation_date"])
